...
public class ExceptionTranslator extends ResponseEntityExceptionHandler {
    ...
    private ProblemDetailWithCause getProblemDetailWithCause(Throwable ex) {
        if (
            ex instanceof it.lookup.bugtracker.service.EmailAlreadyUsedException ||
            ex instanceof it.lookup.bugtracker.service.UsernameAlreadyUsedException
        ) {
        ...
        if (
            ex instanceof it.lookup.bugtracker.service.InvalidPasswordException
